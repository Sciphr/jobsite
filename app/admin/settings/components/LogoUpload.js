...
export default function LogoUpload({ getButtonClasses }) {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h3 className="text-lg font-semibold admin-text mb-2">Site Logo</h3>
      ...
      {logo && (
        <motion.div
          ...
          className="admin-card p-4 rounded-lg border"
        >
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1 min-w-0">
              <h4 className="text-sm font-medium admin-text">Current Logo</h4>
              ...
              <div className="flex items-center space-x-2 mt-3">
                <button
                  ...
                  className="flex items-center space-x-1 px-3 py-1 text-xs bg-blue-50 text-blue-700 rounded hover:bg-blue-100 transition-colors"
                >
                ...
                <button
                  onClick={deleteLogo}
                  disabled={deleting}
                  className="flex items-center space-x-1 px-3 py-1 text-xs bg-red-50 text-red-700 rounded hover:bg-red-100 transition-colors disabled:opacity-50"
                >
                  {deleting ? (
        ...
        <div className="text-center">
          ...
          <div className="space-y-2">
            <p className="text-sm admin-text">
              {uploading ? 'Uploading logo...' : 'Drop your logo here or click to browse'}
            </p>
          ...
          <motion.button
            ...
            disabled={uploading}
            className={`mt-4 flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors ${getButtonClasses("primary")} ${
