...
export default function EmailComposer({
  ...
  return (
    <div className="lg:col-span-2 space-y-6">
      <div>
        <h3 className="text-lg font-semibold mb-4 admin-text">Compose Email</h3>
        ...
        <div className="mb-4">
          ...
          <select
            ...
            className="w-full px-3 py-2 border admin-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 admin-card admin-text"
          >
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            className="w-full px-3 py-2 border admin-border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none admin-card admin-text"
            rows={12}
          />
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <motion.button
              ...
              className="px-4 py-2 border admin-border rounded-lg admin-text hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Preview
            </motion.button>
            <motion.button
