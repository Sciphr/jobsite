  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold admin-text">Email Templates</h3>
      ...
      {/* Filters */}
      <div className="admin-card p-4 rounded-lg space-y-4">
        <div className="flex items-center space-x-2 text-sm font-medium admin-text">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <label className="flex items-center space-x-2 cursor-pointer">
            ...
            />
            <span className="text-sm admin-text">Active only</span>
          </label>
        </div>
        ...
        {(searchTerm || selectedCategory !== "all" || selectedType !== "all" || showActiveOnly) && (
          <div className="flex justify-end">
            <button
              ...
              className="text-sm admin-text-light hover:admin-text underline"
            >
              Clear all filters
            </button>
          </div>
      ...
      {emailTemplates && emailTemplates.length === 0 ? (
        <div className="text-center py-12">
          <p className="admin-text-light text-lg mb-4">No email templates found</p>
          <p className="admin-text-light text-sm">Create your first template to get started</p>
        </div>
      ) : filteredTemplates.length === 0 ? (
        <div className="text-center py-12">
          <p className="admin-text-light text-lg mb-4">No templates match your filters</p>
          <p className="admin-text-light text-sm">Try adjusting your search criteria or clear the filters</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <motion.div
            ...
            className="border admin-border rounded-lg p-6 hover:shadow-md transition-shadow admin-card"
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <h4 className="font-semibold admin-text">{template.name}</h4>
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="p-1 admin-text-light hover:admin-text"
                  title="Edit template"
                >
                ...
                <button
                  ...
                  className="p-1 admin-text-light hover:text-red-600"
            ...
            <div className="mb-4">
              <p className="text-sm font-medium admin-text mb-1">Subject:</p>
              <p className="text-sm admin-text-light truncate">{template.subject}</p>
            </div>

            <div className="mb-4">
              <p className="text-sm font-medium admin-text mb-1">Preview:</p>
              <p className="text-sm admin-text-light line-clamp-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button className="text-sm admin-text-light hover:admin-text">
