  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-2 text-sm admin-text-light">
        ...
        <ChevronRightIcon className="h-4 w-4" />
        <span className="admin-text font-medium">Schedule Interview</span>
      </div>
        ...
        <div className="p-6 min-h-[600px]">
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center space-x-3 mb-3">
                        <Icon className="h-6 w-6 admin-text" />
                        <h4 className="font-semibold admin-text">
                          {option.title}
                        </h4>
                      </div>
                      ...
                      <ul className="space-y-1">
                        {option.pros.map((pro, index) => (
                          <li key={index} className="text-xs admin-text-light flex items-center">
              ...
              {/* Duration Selection */}
              <div>
                <h4 className="text-md font-semibold admin-text mb-3">Interview Duration</h4>
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg border transition-colors ${
                        interviewData.duration === minutes
                          ...
                          : "border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500 admin-text"
                      }`}
                    >
                      {minutes} min
                    </button>
