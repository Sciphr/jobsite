...
export async function createAuditLog(logData) {
  try {
    ...
    if (!eventType || !category || !action) {
      throw new Error('eventType, category, and action are required for audit logging');
    }
...
export const auditUser = {
  login: (userId, userEmail, ipAddress, userAgent) => createAuditLog({
  ...
  logout: (userId, userEmail, ipAddress) => createAuditLog({
  ...
  profileUpdate: (userId, userEmail, oldData, newData, changes, actorId = null) => createAuditLog({
    ...
    actorName: userEmail,
    action: actorId && actorId !== userId ? 'Admin updated user profile' : 'User updated profile',
    oldValues: oldData,
    newValues: newData,
    changes,
    tags: ['profile', 'update']
  ...
  privilegeChange: (userId, userEmail, oldPrivilege, newPrivilege, actorId, actorName) => createAuditLog({
    eventType: EVENT_TYPES.UPDATE,
    category: CATEGORIES.USER,
...
export const auditApplication = {
  create: (applicationId, jobId, userId, applicantName, actorId, actorName) => createAuditLog({
  ...
  statusChange: (applicationId, applicantName, oldStatus, newStatus, actorId, actorName, jobId = null) => createAuditLog({
    eventType: EVENT_TYPES.UPDATE,
    category: CATEGORIES.APPLICATION,
  ...
  noteUpdate: (applicationId, applicantName, oldNotes, newNotes, actorId, actorName) => createAuditLog({
    eventType: EVENT_TYPES.UPDATE,
    category: CATEGORIES.APPLICATION,
...
export const auditJob = {
  create: (jobId, jobTitle, actorId, actorName) => createAuditLog({
    eventType: EVENT_TYPES.CREATE,
  ...
  update: (jobId, jobTitle, oldData, newData, changes, actorId, actorName) => createAuditLog({
    eventType: EVENT_TYPES.UPDATE,
    category: CATEGORIES.JOB,
    entityType: 'job',
    entityId: jobId,
  ...
  publish: (jobId, jobTitle, actorId, actorName) => createAuditLog({
  ...
  feature: (jobId, jobTitle, featured, actorId, actorName) => createAuditLog({
  ...
  delete: (jobId, jobTitle, actorId, actorName) => createAuditLog({
...
export const auditEmail = {
  templateCreate: (templateId, templateName, actorId, actorName) => createAuditLog({
    eventType: EVENT_TYPES.CREATE,
  ...
  templateUpdate: (templateId, templateName, oldData, newData, changes, actorId, actorName) => createAuditLog({
    eventType: EVENT_TYPES.UPDATE,
    category: CATEGORIES.TEMPLATE,
  ...
  send: (emailId, recipientEmail, subject, templateId = null, actorId, actorName, applicationId = null, jobId = null) => createAuditLog({
  ...
  bulkSend: (emailCount, templateId, templateName, actorId, actorName, jobId = null) => createAuditLog({
    eventType: EVENT_TYPES.SEND,
    category: CATEGORIES.EMAIL,
...
export const auditSystem = {
  settingChange: (settingKey, oldValue, newValue, actorId, actorName) => createAuditLog({
    eventType: EVENT_TYPES.UPDATE,
  ...
  error: (errorType, errorMessage, entityType = null, entityId = null, actorId = null, metadata = null) => createAuditLog({
